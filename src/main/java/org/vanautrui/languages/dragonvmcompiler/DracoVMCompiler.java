...
import org.vanautrui.languages.dragonvmcompiler.instructions.IVMInstr;
import org.vanautrui.languages.dragonvmcompiler.instructions.VMInstr;
    ...
    private static List<String> vm_codes_to_assembly(List<IVMInstr> vmcodes) throws Exception {
        ...
        for(IVMInstr instr : vmcodes){
            ...
            switch (instr.getCmd()){
                ...
                case "iconst":
                case "fconst":
                    a.mov(Register.eax,Float.parseFloat(instr.getArg1().get()));
                    a.push(Register.eax);
                    break;
                case "pop":
                ...
                case "call":
                    ...
                    if(method.equals("putchar")){
                        ...
                        //prog.pop("ecx");
                        a.mov(Register.eax,4,"sys_writ");
                        a.mov(Register.ebx,1,"std_out");
                        ...
                        a.pop(Register.ecx); //pop digit into ecx
                        a.add(Register.ecx,0x30); //add ascii offset
                        a.push(Register.ecx);  //push it back on stack
                        a.mov(Register.ecx, Register.esp);
                        //prog.mov("ecx",65);
                ...
                case "neg":
                    a.pop(Register.eax);
                    a.mov(Register.ebx,-1);
                    a.mul(Register.eax, Register.ebx);
                    a.push(Register.eax);
                    break;
                ...
                case "eq":
                    ...
                    a.pop(Register.eax);
                    a.pop(Register.ebx);
                    a.cmp(Register.eax, Register.ebx);
                    a.je(labeltrue);

                    //push 0 (false)
                    a.mov(Register.eax,0);
                    a.push(Register.eax);
                    a.jmp(labelend);

                    a.label(labeltrue);
                    //push 1 (true)
                    a.mov(Register.eax,1);
                    a.push(Register.eax);
                    a.jmp(labelend);
