...
public final class StructDeclNode implements IASTNode, IBasicAndWrappedTypeNode {
	...
	public final SimpleTypeNode type;
	public final List<StructMemberDeclNode> members;
	...
	public String toSourceCode() {
		return "struct " + this.getTypeName() + "{" + this.members.stream().map(member -> member.toSourceCode()).collect(Collectors.joining(",")) + "}";
	}
