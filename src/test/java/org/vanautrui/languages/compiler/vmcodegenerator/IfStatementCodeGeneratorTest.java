...
public class IfStatementCodeGeneratorTest {
    ...
    public void test_can_if_statement()throws Exception{
        String source="public class MainTest23 { public ()~>PInt main{  if (1<2) { putchar('1'); } return 0; } }";
    ...
    public void test_can_if_else_statement()throws Exception{
        String source="public class MainTest24 { public ()~>PInt main{  if (3<2) { putchar('3'); } else { putchar('2'); } return 0;} }";
