...
public final class OperatorCodeGeneratorTest {
    ...
    public void test_can_add_Float()throws Exception{
        ...
        final Process pr = compile_and_run_program_for_testing_with_cmd_args(source,"MainTest2777",new String[0]);
    ...
    public void test_can_sub_Float()throws Exception{
        ...
        final Process pr = compile_and_run_program_for_testing_with_cmd_args(source,"MainTest2775",new String[0]);
        Assert.assertEquals(0,pr.exitValue());
        Assert.assertEquals("1",IOUtils.toString(pr.getInputStream()));
    }
    ...
    public void test_can_multiply_Float()throws Exception{
        ...
        final Process pr = compile_and_run_program_for_testing_with_cmd_args(source,"MainTest2774",new String[0]);
    ...
    public void test_can_div_Float()throws Exception{
        ...
        final Process pr = compile_and_run_program_for_testing_with_cmd_args(source,"MainTest2773",new String[0]);
        Assert.assertEquals(0,pr.exitValue());
        Assert.assertEquals("1",IOUtils.toString(pr.getInputStream()));
    }
    ...
    public void test_can_add_Int()throws Exception{
        ...
        final Process pr = compile_and_run_program_for_testing_with_cmd_args(source,"MainTest6777",new String[0]);
        Assert.assertEquals(0,pr.exitValue());
    ...
    public void test_can_sub_Int()throws Exception{
        ...
        final Process pr = compile_and_run_program_for_testing_with_cmd_args(source,"MainTest6775",new String[0]);
        Assert.assertEquals(0,pr.exitValue());
        Assert.assertEquals("1",IOUtils.toString(pr.getInputStream()));
    }
    ...
    public void test_can_multiply_Int()throws Exception{
        ...
        final Process pr = compile_and_run_program_for_testing_with_cmd_args(source,"MainTest6774",new String[0]);
        Assert.assertEquals(0,pr.exitValue());
    ...
    public void test_can_div_Int()throws Exception{
        final String source="fn main ()~>PInt { putdigit(3 / 2); return 0;} ";
        final Process pr = compile_and_run_program_for_testing_with_cmd_args(source,"MainTest6773",new String[0]);
        Assert.assertEquals(0,pr.exitValue());
        Assert.assertEquals("1",IOUtils.toString(pr.getInputStream()));
    }
    ...
    public void test_can_modulo_Int()throws Exception{
        final String source="fn main ()~>PInt { putdigit(3 % 2); return 0;} ";
        final Process pr = compile_and_run_program_for_testing_with_cmd_args(source,"MainTest67373",new String[0]);
        Assert.assertEquals(0,pr.exitValue());
        Assert.assertEquals("1",IOUtils.toString(pr.getInputStream()));
    }
    ...
    public void test_can_bitshift_1()throws Exception{
        ...
        final Process pr = compile_and_run_program_for_testing_with_cmd_args(source,"MainTest673733",new String[0]);
        Assert.assertEquals(0,pr.exitValue());
    ...
    public void test_can_bitshift_2()throws Exception{
        final String source="fn main ()~>PInt { putdigit(2 >> 1); return 0;} ";
        final Process pr = compile_and_run_program_for_testing_with_cmd_args(source,"MainTest673734",new String[0]);
        Assert.assertEquals(0,pr.exitValue());
        Assert.assertEquals("1",IOUtils.toString(pr.getInputStream()));
    }
    ...
    public void test_can_exp_int()throws Exception{
        ...
        final Process pr = compile_and_run_program_for_testing_with_cmd_args(source,"MainTest6737341",new String[0]);
