...
- [x] no backwards compatibility (the language will change whenever a feature gets added / removed from the language. no consideration will be given to existing code. )
