...
void test_liveness_def_map_tac_param() {
	...
	tacbuffer_append(buf, makeTACConst(1, 33));
	tacbuffer_append(buf, makeTACParam(1, true));
...
void test_liveness_def_map_tac_goto() {
	...
	tacbuffer_append(buf, makeTACConst(0, 33));
...
void test_liveness_def_map_tac_store_local() {
	...
	tacbuffer_append(buf, makeTACConst(1, 99));
	tacbuffer_append(buf, makeTACStoreLocal(0, 1));
...
void test_liveness_def_map_tac_load_const_addr() {

	status("TAC_LOAD_CONST_ADDR");

	struct TACBuffer* buf = tacbuffer_ctor();

	tacbuffer_append(buf, makeTACLoadConstAddr(1, 0xaf));
...
void test_liveness_def_map_tac_store_const_addr() {
	...
	tacbuffer_append(buf, makeTACConst(1, 99));
	tacbuffer_append(buf, makeTACStoreConstAddr(0xaf, 1));
...
void test_liveness_def_map_tac_load() {
	...
	tacbuffer_append(buf, makeTACConst(1, 0xaf));
	tacbuffer_append(buf, makeTACLoad(2, 1, 2));
...
void test_liveness_def_map_tac_store() {
	...
	tacbuffer_append(buf, makeTACConst(1, 0xaf));
	tacbuffer_append(buf, makeTACStore(0xaf, 1));
...
void test_liveness_def_map_tac_binary_op() {
	...
	tacbuffer_append(buf, makeTACConst(1, 0xaf));
	tacbuffer_append(buf, makeTACConst(2, 0xaf));
	tacbuffer_append(buf, makeTACBinOp(2, TAC_OP_OR, 1));
...
void test_liveness_def_map_tac_unary_op() {
	...
	tacbuffer_append(buf, makeTACConst(2, 9));
	tacbuffer_append(buf, makeTACUnaryOp(2, 1, TAC_OP_UNARY_NOT));
...
void test_liveness_def_map_tac_binary_op_immediate() {
	...
	tacbuffer_append(buf, makeTACConst(1, 0xaf));
	tacbuffer_append(buf, makeTACConst(2, 0xaf));
	tacbuffer_append(buf, makeTACBinOpImmediate(2, TAC_OP_OR, 1234));
