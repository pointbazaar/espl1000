...
void test_gen_tac_call_case_1_args_write_8bit() {
	...
	char snippet[200];
	char* template = "fn main()->int{ f(%d); return 0; } fn f(uint8 a)->int { *uint8 ptr =0x100; *ptr=a; return 0; }";
...
void test_gen_tac_call_case_1_args_write_16bit() {
	...
	char snippet[200];
	char* template = "fn main()->int{ f(%d); return 0; } fn f(uint16 a)->int { *uint16 ptr = 0x100; *ptr=a; return 0; }";
	sprintf(snippet, template, expected);
...
void test_gen_tac_call_case_1_args_write_3fns() {
	...
	char snippet[200];
	char* template = "fn main()->int{ return f1(%d); } fn f1(uint8 a)->int {return f2(a);} fn f2 (uint8 b)->int{ *uint8 ptr = 0x101; *ptr=b; return 0; }";
	sprintf(snippet, template, expected);
